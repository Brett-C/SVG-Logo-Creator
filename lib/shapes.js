...
class Square extends Shape {
    ...
    generate() {
        return `<rect width="300" height="200"  fill="${this.shape_color}" stroke="black" stroke-width="5"></rect>
...
class Triangle extends Shape {
    ...
    generate() {
        return `<polygon points="50, 195 150, 5 250, 195"   fill="${this.shape_color}" stroke="black" stroke-width="5"></polygon>
